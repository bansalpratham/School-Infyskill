...
router.post('/', verifyToken, authorizeRole('admin', 'teacher'), examController.create);
router.get('/', verifyToken, authorizeRole('admin', 'teacher', 'student'), ensureStudentClassMatchesQuery, examController.list);
router.delete('/:id', verifyToken, authorizeRole('admin', 'teacher'), examController.remove);
